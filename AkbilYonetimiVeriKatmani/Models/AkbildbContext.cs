...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-HK437QT;Database=AKBILDB;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Akbiller>(entity =>
        {
            entity.HasKey(e => e.AkbilNo).HasName("PK__Akbiller__ADBC64565FA89DD2");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Kullanic__3214EC07CE82AC4F");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Talimatl__3214EC07D83564B0");
